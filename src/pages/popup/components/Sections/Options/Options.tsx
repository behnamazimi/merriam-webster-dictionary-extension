        ...
        {(isUsingFreeApiDetails || showGuide) && (
          <>
            <p>
              ...
              {" "}
              {" "}
              <a href="https://dictionaryapi.com/register/index" target="_blank" rel="noreferrer">
                do free register
                here
              </a>
              {" "}
            ...
            <p>
              ...
              {" "}
              {" "}
              <a href="https://dictionaryapi.com/products/index" target="_blank" rel="noreferrer">
                read their details
                here
              </a>
              .
            ...
            && (
              <Alert
                header="Free searches have been consumed!"
